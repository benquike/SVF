    ...
    protected:
        ...
        void cmp_symtableid_and_pagid(string &bc_file) {
            ...
            for (auto it1 = mod->global_begin(), it2 = mod2->global_begin();
                ...
                ASSERT_EQ(symInfo->getValSym(*it1),
                          symInfo2->getValSym(*it2));
            ...
            for (; it1 != mod->llvmFunEnd() && it2 != mod2->llvmFunEnd();
                ...
                ASSERT_EQ(symInfo->getValSym(fun1),
                          symInfo2->getValSym(fun2));

                auto bb1 = fun1->begin(), bb2 = fun2->begin();
                for (; bb1 != fun1->end() && bb2 != fun2->end();
                     bb1 ++, bb2 ++) {
                    ...
                    ASSERT_EQ(symInfo->getValSym(pbb1),
                              symInfo2->getValSym(pbb2));
