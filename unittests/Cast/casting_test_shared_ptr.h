...
shared_ptr<FunEntryBlockNode> funEntryBlockNode =
    make_shared<FunEntryBlockNode>();
...
shared_ptr<ActualParmVFGNode> actualParmVFGNode =
    make_shared<ActualParmVFGNode>();
shared_ptr<FormalParmVFGNode> formalParmVFGNode =
    make_shared<FormalParmVFGNode>();
...
shared_ptr<FormalOUTSVFGNode> formalOUTSVFGNode =
    make_shared<FormalOUTSVFGNode>();
shared_ptr<ActualINSVFGNode> actualINSVFGNode = make_shared<ActualINSVFGNode>();
shared_ptr<ActualOUTSVFGNode> actualOUTSVFGNode =
    make_shared<ActualOUTSVFGNode>();
shared_ptr<MSSAPHISVFGNode> mSSAPHISVFGNode = make_shared<MSSAPHISVFGNode>();
shared_ptr<IntraMSSAPHISVFGNode> intraMSSAPHISVFGNode =
    make_shared<IntraMSSAPHISVFGNode>();
shared_ptr<InterMSSAPHISVFGNode> interMSSAPHISVFGNode =
    make_shared<InterMSSAPHISVFGNode>();
...
shared_ptr<ThreadMHPIndSVFGEdge> threadMHPIndSVFGEdge =
    make_shared<ThreadMHPIndSVFGEdge>();
