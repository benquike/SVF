...
unique_ptr<FunEntryBlockNode> funEntryBlockNode =
    unique_ptr<FunEntryBlockNode>();
...
unique_ptr<ActualParmVFGNode> actualParmVFGNode =
    unique_ptr<ActualParmVFGNode>();
unique_ptr<FormalParmVFGNode> formalParmVFGNode =
    unique_ptr<FormalParmVFGNode>();
...
unique_ptr<FormalOUTSVFGNode> formalOUTSVFGNode =
    unique_ptr<FormalOUTSVFGNode>();
unique_ptr<ActualINSVFGNode> actualINSVFGNode = unique_ptr<ActualINSVFGNode>();
unique_ptr<ActualOUTSVFGNode> actualOUTSVFGNode =
    unique_ptr<ActualOUTSVFGNode>();
unique_ptr<MSSAPHISVFGNode> mSSAPHISVFGNode = unique_ptr<MSSAPHISVFGNode>();
unique_ptr<IntraMSSAPHISVFGNode> intraMSSAPHISVFGNode =
    unique_ptr<IntraMSSAPHISVFGNode>();
unique_ptr<InterMSSAPHISVFGNode> interMSSAPHISVFGNode =
    unique_ptr<InterMSSAPHISVFGNode>();
...
unique_ptr<ThreadMHPIndSVFGEdge> threadMHPIndSVFGEdge =
    unique_ptr<ThreadMHPIndSVFGEdge>();
