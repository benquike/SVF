...
//===----------------------------------------------------------------------===//
//
// This file defines the llvm::isa<X>(), cast<X>(), dyn_cast<X>(),
...
// llvm::isa<X> - Return true if the parameter to the template is an instance of
// the template type argument.  Used like this:
//
