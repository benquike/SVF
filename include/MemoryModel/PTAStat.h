...
class PTAStat {
  public:
    ...
    static const char
        *ProcessLoadStoreTime; ///< time of processing loads and stores
    static const char
        *ProcessCopyGepTime; ///< time of processing copys and geps
    ...
    static const char
        *NumOfObjsHasVarStruct; ///< PAG object node has var struct (maybe
                                ///< nested with array)
    static const char *NumOfObjsHasVarArray; ///< PAG object node has var array
                                             ///< (maybe nested with struct)
    static const char
        *NumOfObjsHasConstStruct; ///< PAG object node has const struct (maybe
                                  ///< nested with array)
    static const char
        *NumOfObjsHasConstArray; ///< PAG object node has const array (maybe
                                 ///< nested with struct)
    static const char
        *NumOfNonPtrObjs; ///< PAG object node which is non pointer type object
                          ///< (do not have pts)
    static const char
        *NumOfConstantObjs; ///< PAG object node which is purely constant

    static const char *NumberOfFieldInsensitiveObj;
    static const char *NumberOfFieldSensitiveObj;

    static const char
        *NumOfPointers; ///< PAG value node, each of them maps to a llvm value
    static const char
        *NumOfGepFieldPointers; ///< PAG gep value node (field value,
                                ///< dynamically created dummy node)

    static const char *
        NumOfMemObjects; ///< PAG object node, each of them maps to a llvm value
    static const char
        *NumOfGepFieldObjects; ///< PAG gep object node (field obj, dynamically
                               ///< created dummy node)

    static const char
        *AveragePointsToSetSize; ///< Average points-to size of all variables
    static const char *AverageTopLevPointsToSetSize; ///< Average points-to size
                                                     ///< of top-level variables
    static const char *MaxPointsToSetSize;           ///< Max points-to size

    static const char
        *NumOfIterations; ///< Number of iterations during resolution

    static const char *NumOfIndirectCallSites; ///< Number of indirect callsites
    static const char
        *NumOfIndirectEdgeSolved; ///< Number of indirect calledge resolved
    ...
    static const char
        *NumOfNodesInCycles; ///< Number of nodes in cycles detected
    ...
    virtual inline void endClk() { endTime = CLOCK_IN_MS(); }
    /// When mark is true, real clock is always returned. When mark is false, it
