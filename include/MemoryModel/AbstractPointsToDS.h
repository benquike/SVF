...
/// DataSet --> PointsTo Context sensitive:  			   Key --> CondVar,
/// DataSet --> PointsTo Heap sensitive:     			   Key --> Variable
/// DataSet --> CondPointsToSet Context and heap sensitive:     Key --> CondVar,
/// DataSet --> CondPointsToSet
///
/// This class is abstract to allow for multiple methods of actually storing
/// points-to sets. Key:     "owning" variable of a points-to set. KeySet:
/// collection of keys. Data:    elements in points-to sets. DataSet: the
/// points-to set; a collection of Data.
