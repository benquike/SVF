...
#if defined(ultrix) || defined(SABER) || defined(aiws) || defined(hpux) ||     \
    defined(apollo) || defined(__osf__) || defined(__SVR4) ||                  \
    defined(__GNUC__)
...
#if (defined(__STDC__) || defined(__cplusplus) || defined(ultrix)) &&          \
        !defined(MNEMOSYNE) ||                                                 \
    defined(__SVR4)
#include <stdlib.h>
#else
