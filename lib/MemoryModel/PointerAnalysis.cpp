...
static llvm::cl::opt<bool>
    CallGraphDotGraph("dump-callgraph", llvm::cl::init(false),
                      llvm::cl::desc("Dump dot graph of Call Graph"));

static llvm::cl::opt<bool>
    PAGPrint("print-pag", llvm::cl::init(false),
             llvm::cl::desc("Print PAG to command line"));

static llvm::cl::opt<unsigned>
    IndirectCallLimit("indCallLimit", llvm::cl::init(50000),
                      llvm::cl::desc("Indirect solved call edge limit"));

static llvm::cl::opt<bool> UsePreCompFieldSensitive(
    "preFieldSensitive", llvm::cl::init(true),
    llvm::cl::desc("Use pre-computed field-sensitivity for later analysis"));

static llvm::cl::opt<bool>
    EnableAliasCheck("alias-check", llvm::cl::init(true),
 ...
 */
bool PointerAnalysis::dumpGraph() { return PAGDotGraph; }
