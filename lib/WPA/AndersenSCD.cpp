 ...
 * Source nodes of new added edges whose pts differ from those of dst nodes are
 * pushed into worklist.
 */
...
/*!
 * If one copy edge is successful added, the src node should be added into SCC
 * detection
 */
 ...
 */
bool AndersenSCD::updateCallGraph(
    const PointerAnalysis::CallSiteToFunPtrMap &callsites) {
